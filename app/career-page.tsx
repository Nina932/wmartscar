    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} id="top">
        <div className={styles.heroWords}>
          ...
          <p>
            Way Mart-ში დღე სწრაფად გადის — ბევრი ადამიანი, ბევრი პატარა საქმე
            და გუნდი, რომელიც ყველაფერს ერთად უმკლავდება. თუ ასეთი ტემპი შენია,
            შემოგვიერთდი.
          </p>
      ...
      <section className={styles.story} id="story">
        <div className={styles.sectionIntro}>
          <span>01 / მეტი ვიდრე convenience store</span>
          ...
          <p>
            ...
            store — ყავა, ცხელი საკვები და ყოველდღიური პროდუქტები ერთ სივრცეში.
            აქ დღე შეიძლება მშვიდად დაიწყოს და რამდენიმე წუთში სრულიად
            აჩქარდეს.
          </p>
        </div>
        ...
        <div className={styles.storyGrid}>
          ...
          <article className={styles.statementCard}>
            ...
            <p>
              „ყველაზე დატვირთულ დღესაც მნიშვნელოვანია, როგორ ხვდები ადამიანს.“
            </p>
      ...
      <section className={styles.moments} id="moments">
        <div className={styles.momentHead}>
          ...
          <p>
            ...
            ვიღაც ყავას ელოდება.
            <br />
            ვიღაც სწრაფად აკეთებს საყიდლებს.
            <br />
            ...
            <br />
            <br />
            ამ ყველაფრის შუაში არის გუნდი — ადამიანები, რომლებიც ერთმანეთს
